...
Avatar.prototype.handle = function(stanza) {
    ...
    try {
        ...
        if (0 === metadata.children.length)
            ...
            this._addMetadata(metadata.getChild('info'), data)
...
Avatar.prototype._addMetadata = function(stanza, data) {
    var properties = [ 'id', 'width', 'height', 'type', 'bytes' ]
    var value
    properties.forEach(function(property) {
        if (null !== (value = stanza.attrs[property]))
            data[property] = stanza.attrs[property]
    })
}
